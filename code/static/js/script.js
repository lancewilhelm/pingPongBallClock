    ...
    xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            ...
            document.documentElement.style.setProperty(
                "--main-bg-color",
                webPageSettings.mainBGColor
            );
            document.querySelector(".page-color-preview").style.background =
                webPageSettings.mainBGColor;

            // Board Type
            document.getElementById("boardType").value =
                webPageSettings.boardType;

            // Line Count
            document.getElementById("lineCount").value =
                webPageSettings.lineCount;

            // Brightness
            document.getElementById("brightnessSlider").value =
                webPageSettings.brightness;

            //Line 1 Content
            document.getElementById("line1time").checked =
                webPageSettings.line1time;
            document.getElementById("line1date").checked =
                webPageSettings.line1date;
            document.getElementById("line1weather").checked =
                webPageSettings.line1weather;
            document.getElementById("line1text").checked =
                webPageSettings.line1text;

            //Line 2 Content
            document.getElementById("line2time").checked =
                webPageSettings.line2time;
            document.getElementById("line2date").checked =
                webPageSettings.line2date;
            document.getElementById("line2weather").checked =
                webPageSettings.line2weather;
            document.getElementById("line2text").checked =
                webPageSettings.line2text;

            // Line 1 Speed Input
            document.getElementById("line1SpeedInput").value =
                webPageSettings.line1Speed;

            // Line 2 Speed Input
            document.getElementById("line2SpeedInput").value =
                webPageSettings.line2Speed;

            // Custom Text Input
            document.getElementById("textInput").value =
                webPageSettings.customText;
...
function sendWebPageSettings() {
    ...
    var settings = {
        ...
        mainBGColor: document.querySelector(".page-color-preview").style
            .background,
...
function setCustomBGColor(color) {
    ...
    var green = document.querySelector(".bg-color-picker .bg-green-slider")
        .value;
...
function setCustomTextColor(color) {
    var xhttp = new XMLHttpRequest();
    var red = document.querySelector(".text-color-picker .text-red-slider")
        .value;
    var green = document.querySelector(".text-color-picker .text-green-slider")
        .value;
    var blue = document.querySelector(".text-color-picker .text-blue-slider")
        .value;
...
function setContent(id, content, lineNum) {
    ...
    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhttp.send(
        "content=" + content + "&lineNum=" + lineNum + "&checked=" + checked
    );
...
function setTextAnimation(animation, lineNum) {
    ...
    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhttp.send(
        "animation=" + animation + "&speed=" + speed + "&lineNum=" + lineNum
    );
...
function setPageRgb() {
    var red = document.querySelector(
        ".modal-body .page-color-picker .page-red-slider"
    ).value;
    var green = document.querySelector(
        ".modal-body .page-color-picker .page-green-slider"
    ).value;
    var blue = document.querySelector(
        ".modal-body .page-color-picker .page-blue-slider"
    ).value;
    var color = "rgb(" + red + "," + green + "," + blue + ")";
    document.querySelector(
        ".modal-body .page-color-preview"
